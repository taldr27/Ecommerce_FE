            ...
            <div className="p-5">
              ...
              <div className="grid grid-cols-2 ">
                <span className="text-gray-600">
                  SKU: <b className="font font-semibold text-black">######{data.id}</b>
                </span>
                <span className="text-gray-600">
                  Disponibilidad:{" "}
                  <b className="font font-semibold text-green-500">
                    Disponible
                  </b>
                </span>
                <span className="text-gray-600">
                  Marca:{" "}
                  <b className="font font-semibold text-black">Estandar</b>
                </span>
                <span className="text-gray-600">
                  Categoria:{" "}
